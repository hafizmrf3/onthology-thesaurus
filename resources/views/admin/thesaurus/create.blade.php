            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{ route('admin.thesaurus.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                -->
                                    ...
                                    <br>
                                    <div class="form-line">
                                        <input type="text" id="author" class="form-control" name="author"  value="{{ Auth::user()->name }}">
                                        <label class="form-label">Author :</label>
                                    </div>
                                    <br>
                                    
                                </div> 
                                <a class="btn btn-danger m-t-15 waves-effect" href="{{ route('admin.thesaurus.index') }}">BACK</a>
