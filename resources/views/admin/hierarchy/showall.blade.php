                                                        ...
                                                        @foreach($thesauruses as $key=>$thesaurus)
                                                            <tr>
                                                                <td class="text-center">
                                                                    <a href="{{ route('admin.hierarchy.wordmap', $thesaurus->id) }}" class="btn btn-info waves-effect">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="home_with_icon_title">
                            ...
                            <div class="card">
                                ...
                                <a class="btn bg-orange m-t-15 waves-effect" href="{{ Route('admin.hierarchy.index') }}"><i class="material-icons">keyboard_backspace</i>BACK</a>       
